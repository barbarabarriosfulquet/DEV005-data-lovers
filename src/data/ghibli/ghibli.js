export default {
  ...
  "films": [
    ...
    },
    {
      ...
      "description": "Dos hermanas se mudan al campo con su padre para estar más cerca de su madre hospitalizada, y descubren que los árboles de los alrededores están habitados por Totoros, espíritus mágicos del bosque. Cuando la más joven se escapa de casa, la hermana mayor busca la ayuda de los espíritus para encontrarla.",
      "director": "Hayao Miyazaki",
    ...
    },
    {
      ...
      "description": "Una joven bruja, en su año obligatorio de vida independiente, encuentra difícil adaptarse a una nueva comunidad mientras se mantiene a sí misma dirigiendo un servicio de mensajería aérea.",
      "director": "Hayao Miyazaki",
      "producer": "Hayao Miyazaki",
    ...
    },
    {
      ...
      "description": "En la última parte de la Segunda Guerra Mundial, un niño y su hermana, huérfanos cuando su madre es asesinada en el bombardeo de Tokio, quedan solos para sobrevivir por su cuenta en lo que queda de la vida civil en Japón. La trama sigue a este niño y su hermana mientras hacen lo posible por sobrevivir en el campo japonés, luchando contra el hambre, el prejuicio y el orgullo en su propia batalla personal y silenciosa.",
    ...
    },
    {
      ...
      "description": "Es 1982 y Taeko tiene 27 años, es soltera y ha vivido toda su vida en Tokio. Decide visitar a su familia en el campo y mientras el tren viaja durante la noche, los recuerdos de su juventud inundan su mente: los primeros movimientos inmaduros del romance, el comienzo de la pubertad y las frustraciones de las matemáticas y los chicos. En la estación la recibe el joven granjero Toshio, y los encuentros con él comienzan a reconectarla con anhelos olvidados. En cambios líricos entre el presente y el pasado, Taeko contempla el arco de su vida y se pregunta si ha sido fiel a los sueños de su yo infantil.",
      "director": "Isao Takahata",
    ...
    },
    {
      ...
      "title": "Porco Rosso",
      "description": "Porco Rosso, conocida en Japón como Crimson Pig (Kurenai no Buta), es la sexta película animada de Hayao Miyazaki y fue estrenada en 1992. Te presenta a un as de combate italiano de la Primera Guerra Mundial, que ahora vive como un cazador de recompensas independiente persiguiendo a los 'piratas del aire' en el mar Adriático. Ha sido maldecido y su cabeza ha sido transformada en la de un cerdo. Antes llamado Marco Pagot, ahora es conocido en todo el mundo como 'Porco Rosso', que en italiano significa 'Cerdo Rojo'.",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "title": "Pom Poko",
      "description": "A medida que el desarrollo de la ciudad humana invade el hábitat de los mapaches en el bosque y en los prados, los mapaches se enfrentan a la posibilidad muy real de la extinción. En respuesta, los mapaches se involucran en una lucha desesperada para detener la construcción y preservar su hogar.",
      "director": "Isao Takahata",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Shizuku ama los libros y la escritura. Cuando descubre que alguien ha sacado todos los libros de la biblioteca antes que ella, conoce a Seiji, su 'Príncipe de los Libros'. Él quiere ser fabricante de violines en Italia, lo que inspira a Shizuku a encontrar su camino en la vida. Ella escribe una historia sobre la estatuilla de gato de Baron, que pertenece al abuelo de Seiji.",
    ...
    },
    {
      ...
      "description": "Ashitaka, un príncipe de la tribu Ainu en peligro de extinción, es maldecido por un dios jabalí demoníaco y debe emprender un viaje hacia el oeste para encontrar una cura. En el camino, se encuentra con San, una joven mujer humana que lucha por proteger el bosque, y con Lady Eboshi, quien intenta destruirlo. Ashitaka debe encontrar una manera de equilibrar este conflicto.",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Los Yamada son una típica familia japonesa de clase media en la ciudad urbana de Tokio, y esta película nos muestra una variedad de episodios de sus vidas. Con historias que van desde lo humorístico hasta lo desgarrador, vemos a esta familia lidiar con los pequeños conflictos, problemas y alegrías de la vida a su manera.",
      "director": "Isao Takahata",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "title": "Spirited Away",
      "description": "'Spirited Away' es una película de animación japonesa ganadora del Oscar sobre una niña de diez años que se aleja de sus padres por un camino que la lleva a un mundo gobernado por extrañas y inusuales criaturas parecidas a monstruos. Sus padres han sido convertidos en cerdos junto con otros dentro de un baño público lleno de estas criaturas. ¿Volverá a ver el mundo como era antes?",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Haru, una estudiante aburrida de su rutina diaria, salva la vida de un gato inusual y de repente su mundo es transformado más allá de lo que jamás imaginó. El Rey Gato recompensa su buena acción con una ráfaga de regalos, ¡incluyendo una sorprendente propuesta de matrimonio con su hijo! Haru se embarca en un viaje inesperado al Reino de los Gatos donde sus ojos son abiertos a un mundo completamente diferente.",
    ...
    },
    {
      ...
      "description": "Cuando Sophie, una joven tímida, es maldecida con un cuerpo de anciana por una bruja malvada, su única oportunidad de romper el hechizo radica en un joven mago egoísta pero inseguro y sus compañeros en su hogar ambulante de patas.",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Algo extraño ha sucedido en el reino, el país se está deteriorando. La gente está empezando a actuar de forma extraña y están empezando a ver dragones. Debido a todos estos eventos extraños, Ged, un mago errante, está investigando la causa. Durante su viaje, conoce al Príncipe Arren, un joven adolescente angustiado. Aunque Arren pueda parecer un tímido joven adolescente, tiene un lado oscuro severo que le otorga fuerza, odio, despiadada crueldad y no tiene piedad, especialmente cuando se trata de proteger a Teru. Para la bruja Kumo, esta es una oportunidad perfecta.",
    ...
    },
    {
      ...
      "description": "Sosuke, un niño de 5 años hijo de un marinero, vive con su madre Lisa en un acantilado junto al mar. Un día encuentra un pez dorado atrapado en una botella en la playa y lo rescata, llamándolo Ponyo. Resulta que Ponyo no es un pez común, sino la hija de un mago y una diosa del mar, que utiliza la magia para convertirse en una niña y enamorarse de Sosuke. Sin embargo, su magia causa un peligroso desequilibrio en el mundo, y los dos niños emprenden una aventura para salvar el mundo y cumplir el sueño de Ponyo de convertirse en humana.",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Arrietty de 14 años y el resto de la familia Clock, viven en paz y en el anonimato, construyendo su propio hogar a partir de objetos 'prestados' de los humanos que viven en la casa. Sin embargo, la vida cambia para los Clock cuando un niño humano descubre a Arrietty.",
    ...
    },
    {
      ...
      "description": "La historia transcurre en 1963 en Yokohama. Kokuriko Manor se encuentra en una colina con vistas al puerto. Una chica de 16 años llamada Umi vive en esa casa. Cada mañana iza una bandera de señales frente al mar. La bandera significa 'Rezo por viajes seguros'. Un chico de 17 años, Shun, siempre ve esta bandera desde el mar mientras viaja en un remolcador hacia la escuela. Poco a poco, ambos se sienten atraídos el uno por el otro, pero se enfrentan a una repentina prueba. Aun así, siguen adelante sin huir de enfrentar las dificultades de la realidad.",
      "director": "Gorō Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Una pasión de toda la vida por el vuelo inspira al ingeniero aeronáutico japonés Jiro Horikoshi, cuya carrera legendaria incluye la creación del avión de combate A-6M de la Segunda Guerra Mundial.",
      "director": "Hayao Miyazaki",
      "producer": "Toshio Suzuki",
    ...
    },
    {
      ...
      "description": "Un cortador de bambú llamado Sanuki no Miyatsuko descubre una niña pequeña dentro de un brote de bambú brillante. Creyendo que es una presencia divina, él y su esposa deciden criarla como si fuera suya, llamándola 'Princesa'.",
      "director": "Isao Takahata",
    ...
    },
    {
      ...
      "description": "La película sigue a Anna Sasaki viviendo con sus familiares en un pueblo costero. Anna encuentra una mansión abandonada cercana, donde conoce a Marnie, una misteriosa chica que le pide que prometa mantener sus secretos en secreto para todos. A medida que avanza el verano, Anna pasa más tiempo con Marnie y finalmente aprende la verdad sobre su familia y su cuidado de crianza.",
      "director": "Hiromasa Yonebayashi",
      "producer": "Yoshiaki Nishimura",
